...
Why random often beats grid for the *same budget*: when only one parameter really matters,
a grid wastes trials repeating its values, while random search tries a **distinct value
every time** — covering the important axis far better:

<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 520 280" style="width:100%;max-width:520px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Grid search vs random search with 9 trials each. The grid's 9 points fall on only 3 distinct values of the important (horizontal) parameter; random search's 9 points give 9 distinct values, covering the important axis much better."><rect x="1" y="1" width="518" height="278" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><text x="130" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">grid search (9 trials)</text><text x="390" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">random search (9 trials)</text><rect x="45" y="44" width="160" height="160" fill="#FFFFFF" stroke="#E2E2DA"/><rect x="315" y="44" width="160" height="160" fill="#FFFFFF" stroke="#E2E2DA"/><g fill="#185FA5"><circle cx="85" cy="84" r="4.5"/><circle cx="125" cy="84" r="4.5"/><circle cx="165" cy="84" r="4.5"/><circle cx="85" cy="124" r="4.5"/><circle cx="125" cy="124" r="4.5"/><circle cx="165" cy="124" r="4.5"/><circle cx="85" cy="164" r="4.5"/><circle cx="125" cy="164" r="4.5"/><circle cx="165" cy="164" r="4.5"/></g><g fill="#185FA5"><circle cx="332" cy="180" r="4.5"/><circle cx="349" cy="92" r="4.5"/><circle cx="366" cy="198" r="4.5"/><circle cx="383" cy="132" r="4.5"/><circle cx="400" cy="70" r="4.5"/><circle cx="417" cy="160" r="4.5"/><circle cx="434" cy="108" r="4.5"/><circle cx="451" cy="190" r="4.5"/><circle cx="468" cy="142" r="4.5"/></g><g stroke="#9A6A2A" stroke-width="2"><line x1="85" y1="212" x2="85" y2="220"/><line x1="125" y1="212" x2="125" y2="220"/><line x1="165" y1="212" x2="165" y2="220"/></g><g stroke="#1D9E75" stroke-width="2"><line x1="332" y1="212" x2="332" y2="220"/><line x1="349" y1="212" x2="349" y2="220"/><line x1="366" y1="212" x2="366" y2="220"/><line x1="383" y1="212" x2="383" y2="220"/><line x1="400" y1="212" x2="400" y2="220"/><line x1="417" y1="212" x2="417" y2="220"/><line x1="434" y1="212" x2="434" y2="220"/><line x1="451" y1="212" x2="451" y2="220"/><line x1="468" y1="212" x2="468" y2="220"/></g><text x="130" y="238" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#9A6A2A">→ only 3 distinct values tried</text><text x="390" y="238" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#1D9E75">→ 9 distinct values tried</text><text x="260" y="262" text-anchor="middle" font-family="sans-serif" font-size="11" fill="#6B6A66">horizontal axis = the parameter that matters · vertical = one that barely does</text></svg></div>

## 5. Nested cross-validation

If you tune **and** report on the *same* CV, the reported score is optimistic — you picked
the luckiest setting, so that score is itself "trained on" the validation folds. **Nested
CV** fixes this with two loops: an **inner** loop that tunes the hyperparameters, wrapped
inside an **outer** loop that only *evaluates* the already-tuned model on folds the inner
loop never saw:

<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 500 290" style="width:100%;max-width:500px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Nested cross-validation: an outer 3-fold loop where each round holds out a test fold, and inside each outer training part an inner 3-fold loop rotates a validation fold to choose hyperparameters. The outer test folds, never seen by tuning, give the honest score."><rect x="1" y="1" width="498" height="288" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><text x="300" y="22" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">Outer loop — honest estimate</text><g stroke="#FFFFFF"><rect x="160" y="34" width="90" height="26" fill="#EBB661"/><rect x="256" y="34" width="90" height="26" fill="#E3E6EA"/><rect x="352" y="34" width="90" height="26" fill="#E3E6EA"/><rect x="160" y="64" width="90" height="26" fill="#E3E6EA"/><rect x="256" y="64" width="90" height="26" fill="#EBB661"/><rect x="352" y="64" width="90" height="26" fill="#E3E6EA"/><rect x="160" y="94" width="90" height="26" fill="#E3E6EA"/><rect x="256" y="94" width="90" height="26" fill="#E3E6EA"/><rect x="352" y="94" width="90" height="26" fill="#EBB661"/></g><g font-family="sans-serif" font-size="10.5" fill="#6B6A66" text-anchor="end"><text x="152" y="51">outer 1</text><text x="152" y="81">outer 2</text><text x="152" y="111">outer 3</text></g><defs><marker id="ncar" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 z" fill="#6B6A66"/></marker></defs><line x1="300" y1="126" x2="300" y2="152" stroke="#6B6A66" stroke-width="1.6" marker-end="url(#ncar)"/><text x="362" y="142" font-family="sans-serif" font-size="10" fill="#6B6A66">re-split each outer-train</text><text x="300" y="170" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">Inner loop — tune hyperparameters</text><g stroke="#FFFFFF"><rect x="210" y="180" width="84" height="22" fill="#7FB2DE"/><rect x="298" y="180" width="84" height="22" fill="#E3E6EA"/><rect x="386" y="180" width="84" height="22" fill="#E3E6EA"/><rect x="210" y="206" width="84" height="22" fill="#E3E6EA"/><rect x="298" y="206" width="84" height="22" fill="#7FB2DE"/><rect x="386" y="206" width="84" height="22" fill="#E3E6EA"/><rect x="210" y="232" width="84" height="22" fill="#E3E6EA"/><rect x="298" y="232" width="84" height="22" fill="#E3E6EA"/><rect x="386" y="232" width="84" height="22" fill="#7FB2DE"/></g><g font-family="sans-serif" font-size="10.5" fill="#6B6A66" text-anchor="end"><text x="202" y="195">inner 1</text><text x="202" y="221">inner 2</text><text x="202" y="247">inner 3</text></g><g font-family="sans-serif" font-size="10"><rect x="40" y="266" width="11" height="11" fill="#EBB661"/><text x="55" y="275" fill="#6B6A66">test (outer)</text><rect x="150" y="266" width="11" height="11" fill="#7FB2DE"/><text x="165" y="275" fill="#6B6A66">validation (inner)</text><rect x="300" y="266" width="11" height="11" fill="#E3E6EA"/><text x="315" y="275" fill="#6B6A66">train</text></g></svg></div>

The inner loop chooses the hyperparameters; the **untouched outer test folds** then score
that choice — average the outer scores for an honest estimate. It's costlier (folds ×
folds × grid), but it's the gold standard when data is too scarce for a separate test set.
...
<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 540 280" style="width:100%;max-width:540px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Left, a learning curve: training error stays near zero while validation error falls as data grows but keeps a gap — the signature of high variance. Right, a validation curve: training error keeps dropping with tree depth while validation error bottoms out near depth 5 then flattens — the sweet spot."><rect x="1" y="1" width="538" height="278" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><g font-family="sans-serif" font-size="11"><line x1="186" y1="15" x2="206" y2="15" stroke="#185FA5" stroke-width="2.4"/><text x="210" y="19" fill="#185FA5">train</text><line x1="266" y1="15" x2="286" y2="15" stroke="#A32D2D" stroke-width="2.4"/><text x="290" y="19" fill="#A32D2D">validation</text></g><text x="155" y="34" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">learning curve (vs data size)</text><line x1="55" y1="235" x2="258" y2="235" stroke="#C9C8C1" stroke-width="1.2"/><line x1="55" y1="45" x2="55" y2="235" stroke="#C9C8C1" stroke-width="1.2"/><polyline points="55,230 94,230 133,230 172,229 211,230 250,229" fill="none" stroke="#185FA5" stroke-width="2.4"/><polyline points="55,66 94,109 133,102 172,109 211,128 250,115" fill="none" stroke="#A32D2D" stroke-width="2.4"/><text x="155" y="252" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#9C9B95">training-set size →</text><text x="40" y="50" font-family="sans-serif" font-size="10.5" fill="#9C9B95">error</text><text x="150" y="200" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#6B6A66">↕ gap = variance</text><text x="398" y="34" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">validation curve (vs depth)</text><line x1="300" y1="235" x2="503" y2="235" stroke="#C9C8C1" stroke-width="1.2"/><line x1="300" y1="45" x2="300" y2="235" stroke="#C9C8C1" stroke-width="1.2"/><line x1="371" y1="50" x2="371" y2="235" stroke="#1D9E75" stroke-width="1.3" stroke-dasharray="5 3"/><text x="371" y="44" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#1D9E75">sweet spot</text><polyline points="300,83 318,104 335,138 353,168 371,188 389,205 406,218 424,224 442,228 460,229 477,230 495,230" fill="none" stroke="#185FA5" stroke-width="2.4"/><polyline points="300,71 318,80 335,105 353,128 371,132 389,123 406,120 424,113 442,113 460,115 477,113 495,113" fill="none" stroke="#A32D2D" stroke-width="2.4"/><text x="400" y="252" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#9C9B95">model complexity (tree depth) →</text></svg></div>

Read them together: a learning curve says **whether more data will help** (it won't, for
high bias), and a validation curve says **which complexity to pick**. Both are just the M0
under/over-fit story, measured directly.
...
Why it matters: distance- and gradient-based models treat all features in the same units,
so a large-range feature silently drowns out a small-range one until you rescale them:

<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 480 230" style="width:100%;max-width:480px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Before scaling, income's raw range 0 to 100000 fills the axis while age 0 to 80 is a tiny sliver on the same scale, so distance-based models ignore age. After standardizing, income and age span the same range and both count."><rect x="1" y="1" width="478" height="228" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><text x="20" y="28" font-family="sans-serif" font-size="12" fill="#33312E">Before — raw units (one shared scale)</text><text x="98" y="57" text-anchor="end" font-family="sans-serif" font-size="11" fill="#6B6A66">income</text><rect x="105" y="46" width="340" height="14" rx="2" fill="#BFD8EF"/><text x="275" y="57" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#0C447C">range 0 – 100,000</text><text x="98" y="85" text-anchor="end" font-family="sans-serif" font-size="11" fill="#6B6A66">age</text><rect x="105" y="74" width="3" height="14" rx="1" fill="#C0507A"/><text x="120" y="85" font-family="sans-serif" font-size="10" fill="#9C9B95">range 0 – 80 (a sliver)</text><text x="240" y="110" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#A32D2D">income's range dwarfs age's → Euclidean distance ignores age</text><text x="20" y="146" font-family="sans-serif" font-size="12" fill="#33312E">After — standardized (mean 0, std 1)</text><text x="98" y="175" text-anchor="end" font-family="sans-serif" font-size="11" fill="#6B6A66">income (z)</text><rect x="105" y="164" width="150" height="14" rx="2" fill="#BFD8EF"/><text x="98" y="203" text-anchor="end" font-family="sans-serif" font-size="11" fill="#6B6A66">age (z)</text><rect x="105" y="192" width="150" height="14" rx="2" fill="#C0507A"/><text x="268" y="191" font-family="sans-serif" font-size="10.5" fill="#1D9E75">both ≈ [−3, 3] → every feature counts</text></svg></div>
...
The most common one, **one-hot**, turns a single category column into one 0/1 column per
value — exactly one of them is 1 in each row:

<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 520 200" style="width:100%;max-width:520px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="One-hot encoding turns a single 'color' column with values red, green, blue, red into three 0/1 columns is_red, is_green, is_blue, where exactly one column is 1 per row."><defs><marker id="oharrow" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 z" fill="#6B6A66"/></marker></defs><rect x="1" y="1" width="518" height="198" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><rect x="40" y="40" width="90" height="28" fill="#EFEEE8" stroke="#D9D8D1"/><text x="85" y="59" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#33312E">color</text><g stroke="#E2E2DA" fill="#FFFFFF"><rect x="40" y="68" width="90" height="28"/><rect x="40" y="96" width="90" height="28"/><rect x="40" y="124" width="90" height="28"/><rect x="40" y="152" width="90" height="28"/></g><g font-family="sans-serif" font-size="12" text-anchor="middle"><text x="85" y="87" fill="#A32D2D">red</text><text x="85" y="115" fill="#1D9E75">green</text><text x="85" y="143" fill="#185FA5">blue</text><text x="85" y="171" fill="#A32D2D">red</text></g><text x="200" y="104" text-anchor="middle" font-family="sans-serif" font-size="11" fill="#6B6A66">one-hot</text><line x1="160" y1="114" x2="244" y2="114" stroke="#6B6A66" stroke-width="1.6" marker-end="url(#oharrow)"/><g stroke="#D9D8D1" fill="#EFEEE8"><rect x="250" y="40" width="86" height="28"/><rect x="336" y="40" width="86" height="28"/><rect x="422" y="40" width="86" height="28"/></g><g font-family="sans-serif" font-size="10" text-anchor="middle" fill="#33312E"><text x="293" y="59">is_red</text><text x="379" y="59">is_green</text><text x="465" y="59">is_blue</text></g><g stroke="#E2E2DA"><rect x="250" y="68" width="86" height="28" fill="#E1F5EE"/><rect x="336" y="68" width="86" height="28" fill="#FFFFFF"/><rect x="422" y="68" width="86" height="28" fill="#FFFFFF"/><rect x="250" y="96" width="86" height="28" fill="#FFFFFF"/><rect x="336" y="96" width="86" height="28" fill="#E1F5EE"/><rect x="422" y="96" width="86" height="28" fill="#FFFFFF"/><rect x="250" y="124" width="86" height="28" fill="#FFFFFF"/><rect x="336" y="124" width="86" height="28" fill="#FFFFFF"/><rect x="422" y="124" width="86" height="28" fill="#E1F5EE"/><rect x="250" y="152" width="86" height="28" fill="#E1F5EE"/><rect x="336" y="152" width="86" height="28" fill="#FFFFFF"/><rect x="422" y="152" width="86" height="28" fill="#FFFFFF"/></g><g font-family="sans-serif" font-size="12" text-anchor="middle" fill="#33312E"><text x="293" y="87">1</text><text x="379" y="87">0</text><text x="465" y="87">0</text><text x="293" y="115">0</text><text x="379" y="115">1</text><text x="465" y="115">0</text><text x="293" y="143">0</text><text x="379" y="143">0</text><text x="465" y="143">1</text><text x="293" y="171">1</text><text x="379" y="171">0</text><text x="465" y="171">0</text></g></svg></div>
...
<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 480 240" style="width:100%;max-width:480px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="A class distribution of 950 negatives to 50 positives (95 to 5 percent). A model always predicting negative scores 95 percent accuracy yet catches zero positives. After rebalancing — oversampling/SMOTE, undersampling, or class weights — the two classes are even."><rect x="1" y="1" width="478" height="238" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><text x="20" y="28" font-family="sans-serif" font-size="12" fill="#33312E">Imbalanced — 950 negatives vs 50 positives (95% / 5%)</text><rect x="40" y="44" width="380" height="26" rx="3" fill="#D7D6CF"/><rect x="420" y="44" width="20" height="26" rx="3" fill="#A32D2D"/><text x="230" y="61" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#5A5A54">950 negatives (95%)</text><text x="430" y="86" text-anchor="middle" font-family="sans-serif" font-size="9" fill="#A32D2D">50 pos</text><text x="240" y="106" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#A32D2D">"always predict negative" → 95% accuracy, 0 positives caught — accuracy lies</text><text x="240" y="134" text-anchor="middle" font-family="sans-serif" font-size="11" fill="#6B6A66">rebalance ↓  (oversample / SMOTE · undersample · class weights)</text><text x="20" y="164" font-family="sans-serif" font-size="12" fill="#33312E">Rebalanced — even classes</text><rect x="40" y="178" width="200" height="26" rx="3" fill="#D7D6CF"/><rect x="240" y="178" width="200" height="26" rx="3" fill="#A32D2D"/><text x="140" y="195" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#5A5A54">negatives</text><text x="340" y="195" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#FFFFFF">positives</text><text x="240" y="226" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#1D9E75">now precision / recall / F1 / PR-AUC are meaningful (M2)</text></svg></div>
