...
<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 420 250" style="width:100%;max-width:420px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="The logistic sigmoid squashes any real score z into a probability between 0 and 1, crossing 0.5 at z=0 and saturating toward 0 and 1 in the tails."><rect x="1" y="1" width="418" height="248" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><line x1="40" y1="210" x2="408" y2="210" stroke="#C9C8C1" stroke-width="1.2"/><line x1="40" y1="40" x2="408" y2="40" stroke="#ECEBE4" stroke-width="1" stroke-dasharray="3 3"/><line x1="40" y1="125" x2="408" y2="125" stroke="#ECEBE4" stroke-width="1" stroke-dasharray="3 3"/><line x1="220" y1="40" x2="220" y2="210" stroke="#1D9E75" stroke-width="1.3" stroke-dasharray="4 3"/><polyline points="40,210 48,209 55,209 62,209 70,209 78,209 85,208 92,208 100,207 108,206 115,205 122,204 130,202 138,200 145,197 152,194 160,190 168,185 175,179 182,172 190,164 198,155 205,146 212,136 220,125 228,114 235,104 242,95 250,86 258,78 265,71 272,65 280,60 288,56 295,53 302,50 310,48 318,46 325,45 332,44 340,43 348,42 355,42 362,41 370,41 378,41 385,41 392,41 400,40" fill="none" stroke="#185FA5" stroke-width="2.8"/><g font-family="sans-serif" font-size="11" fill="#9C9B95" text-anchor="end"><text x="35" y="214">0</text><text x="35" y="129">0.5</text><text x="35" y="44">1</text></g><text x="220" y="32" text-anchor="middle" font-family="sans-serif" font-size="11" fill="#1D9E75">z = 0 → p = 0.5</text><text x="120" y="232" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#A32D2D">predict 0</text><text x="320" y="232" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#185FA5">predict 1</text><text x="332" y="64" font-family="sans-serif" font-size="13" fill="#185FA5">p = σ(z)</text><text x="401" y="206" font-family="sans-serif" font-size="12" fill="#9C9B95">z</text></svg></div>
...
<div style="text-align:center;margin:0.6rem 0"><svg viewBox="0 0 360 300" style="width:100%;max-width:360px;height:auto" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Two classes of points in 2D separated by a single straight decision boundary; one side is predicted class 1, the other class 0."><rect x="1" y="1" width="358" height="298" rx="14" fill="#FAFAF7" stroke="#E2E2DA"/><line x1="45" y1="255" x2="340" y2="255" stroke="#C9C8C1" stroke-width="1.2"/><line x1="45" y1="255" x2="45" y2="40" stroke="#C9C8C1" stroke-width="1.2"/><line x1="93" y1="45" x2="268" y2="255" stroke="#33312E" stroke-width="2.5"/><g fill="#A32D2D"><circle cx="197" cy="218" r="4.5"/><circle cx="150" cy="177" r="4.5"/><circle cx="125" cy="169" r="4.5"/><circle cx="79" cy="170" r="4.5"/><circle cx="113" cy="95" r="4.5"/><circle cx="144" cy="172" r="4.5"/><circle cx="130" cy="179" r="4.5"/><circle cx="107" cy="173" r="4.5"/><circle cx="152" cy="170" r="4.5"/><circle cx="166" cy="200" r="4.5"/></g><g fill="#185FA5"><circle cx="243" cy="92" r="4.5"/><circle cx="258" cy="135" r="4.5"/><circle cx="237" cy="113" r="4.5"/><circle cx="298" cy="130" r="4.5"/><circle cx="235" cy="104" r="4.5"/><circle cx="216" cy="131" r="4.5"/><circle cx="268" cy="113" r="4.5"/><circle cx="245" cy="111" r="4.5"/><circle cx="190" cy="88" r="4.5"/><circle cx="214" cy="160" r="4.5"/></g><text x="120" y="38" font-family="sans-serif" font-size="11" fill="#33312E">w·x + b = 0</text><g font-family="sans-serif" font-size="11.5" text-anchor="middle"><text x="300" y="74" fill="#185FA5">class 1</text><text x="300" y="88" fill="#185FA5">p ≥ 0.5</text><text x="86" y="238" fill="#A32D2D">class 0</text><text x="86" y="252" fill="#A32D2D">p &lt; 0.5</text></g><text x="332" y="272" font-family="sans-serif" font-size="12" fill="#9C9B95">x₁</text><text x="28" y="46" font-family="sans-serif" font-size="12" fill="#9C9B95">x₂</text></svg></div>
